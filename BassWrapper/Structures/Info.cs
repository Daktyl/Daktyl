...
namespace Daktyl.Core.Bass.Structures
{
	...
	internal readonly struct Info : IEquatable<Info>
	{
		...
		{
			return flags == other.flags && hwsize == other.hwsize && hwfree == other.hwfree && freesam == other.freesam && free3d == other.free3d && minrate == other.minrate && maxrate == other.maxrate && eax == other.eax && minbuf == other.minbuf && dsver == other.dsver && latency == other.latency && initflags == other.initflags && speakers == other.speakers && freq == other.freq;
		}
